...
import static flash.Flash.secure;

/**
 * A simple example just showing some basic functionality.
 *
 * @author Peter Nicholls, based on (practically identical to in fact)
 *         {@link flash.examples.simple.SimpleExample} by Per Wendel
 */
public class SimpleSecureExample {

    public static void main(String[] args) {

        // port(5678); <- Uncomment this if you want flash to listen on a
        // port different than 4567.

        secure(
            FlashTestUtil.getKeyStoreLocation(),
            FlashTestUtil.getKeystorePassword(), null, null);
