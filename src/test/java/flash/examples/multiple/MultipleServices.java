 ...
 */
package flash.examples.multiple;

import flash.Service;

import static flash.Service.ignite;

/**
 * This example shows how to correctly use the Flash instance API which allows for multiple services.
 * The factory method 'service()' should be statically imported from the Flash class.
 */
