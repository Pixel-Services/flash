...
import flash.embeddedserver.jetty.websocket.WebSocketCreatorFactory.FlashWebSocketCreator;
...
public class WebSocketCreatorFactoryTest {
    ...
    public void testCreateWebSocketHandler() {
        ...
        assertTrue(annotated instanceof FlashWebSocketCreator);
        assertTrue(FlashWebSocketCreator.class.cast(annotated).getHandler() instanceof AnnotatedHandler);

        WebSocketCreator listener =
                WebSocketCreatorFactory.create(new WebSocketHandlerClassWrapper(ListenerHandler.class));
        assertTrue(listener instanceof FlashWebSocketCreator);
        assertTrue(FlashWebSocketCreator.class.cast(listener).getHandler() instanceof ListenerHandler);
    }
