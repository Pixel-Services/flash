...
public class StaticFilesFromArchiveTest {
    ...
    public static void setup() throws Exception {
        ...
        Class<?> flashClass = classLoader.loadClass("flash.Flash");

        Method staticFileLocationMethod = flashClass.getMethod("staticFileLocation", String.class);
        staticFileLocationMethod.invoke(null, "/public-jar");

        Method initMethod = flashClass.getMethod("init");
        initMethod.invoke(null);

        Method awaitInitializationMethod = flashClass.getMethod("awaitInitialization");
    ...
    private static URLClassLoader createExtendedClassLoader() {
        ...
        // no parent classLoader because Flash and the static resources need to be loaded from the same classloader
