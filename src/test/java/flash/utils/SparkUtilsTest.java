...
public class FlashUtilsTest {
    ...
    public void testConvertRouteToList() throws Exception {
        ...
        List<String> actual = FlashUtils.convertRouteToList("/api/person/:id");
    ...
    public void testIsSplat_whenParameterIsASplat() throws Exception {
        ...
        assertTrue("Should return true because parameter is a splat (*)", FlashUtils.isSplat("*"));
    ...
    public void testIsSplat_whenParameterIsNotASplat() throws Exception {
        ...
        assertFalse("Should return true because parameter is not a splat (*)", FlashUtils.isSplat("!"));
