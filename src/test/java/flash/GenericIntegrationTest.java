...
import flash.embeddedserver.jetty.websocket.WebSocketTestClient;
import flash.embeddedserver.jetty.websocket.WebSocketTestHandler;
import flash.examples.exception.BaseException;
import flash.examples.exception.JWGmeligMeylingException;
import flash.examples.exception.NotFoundException;
import flash.examples.exception.SubclassOfBaseException;
    import flash.util.FlashTestUtil;
import flash.util.FlashTestUtil.UrlResponse;

    import static flash.Flash.after;
import static flash.Flash.afterAfter;
...
import static flash.Flash.patch;
import static flash.Flash.path;
import static flash.Flash.post;
import static flash.Flash.staticFileLocation;
import static flash.Flash.webSocket;
...
public class GenericIntegrationTest {
    ...
    public void testEchoParamWithUpperCaseInValue() throws Exception {
        final String camelCased = "ThisIsAValueAndFlashShouldRetainItsUpperCasedCharacters";
    ...
    public void testWebSocketConversation() throws Exception {
        ...
        Assert.assertEquals("onMessage: Hi Flash!", events.get(1));
