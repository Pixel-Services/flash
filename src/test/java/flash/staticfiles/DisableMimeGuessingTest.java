...
public class DisableMimeGuessingTest {
    ...
    public void testMimeTypes() throws Exception {
        ...
        Assert.assertNull(doGet("/img/flashlogo.png").headers.get("Content-Type"));
        Assert.assertNull(doGet("/img/flashlogo.svg").headers.get("Content-Type"));
        Assert.assertNull(doGet("/img/flashlogo").headers.get("Content-Type"));
        Assert.assertNull(doGet("/img/flashlogo").headers.get("Content-Type"));
