...
import static flash.Flash.redirect;

/**
 * Tests the redirect utility methods in {@link flash.Redirect}
 */
public class RedirectTest {
    ...
    public void testRedirectGet() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/hi", null);
    ...
    public void testRedirectPost() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("POST", "/hi", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectPut() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("PUT", "/hi", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectDelete() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("DELETE", "/hi", null);
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectAnyGet() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/any", null);
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectAnyPut() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("PUT", "/any", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectAnyPost() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("POST", "/any", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectAnyDelete() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("DELETE", "/any", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectGetWithSpecificCode() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/hiagain", null);
    ...
    public void testRedirectPostWithSpecificCode() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("POST", "/hiagain", "");
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectPutWithSpecificCode() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("PUT", "/hiagain", "");
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectDeleteWithSpecificCode() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("DELETE", "/hiagain", null);
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectAnyGetWithSpecificCode() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/anyagain", null);
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectAnyPostWithSpecificCode() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("POST", "/anyagain", "");
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectAnyPutWithSpecificCode() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("PUT", "/anyagain", "");
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectAnyDeleteWithSpecificCode() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("DELETE", "/anyagain", null);
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }
