package flash.customerrorpages;
...
import static flash.Flash.internalServerError;
import static flash.Flash.notFound;
...
public class CustomErrorPagesTest {
    ...
    public void testGetHi() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/hello", null);
    ...
    public void testCustomNotFound() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/othernotmapped", null);
    ...
    public void testCustomInternal() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/raiseinternal", null);
    ...
    public void testCustomInternalFailingRoute() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/raiseinternal?" + QUERY_PARAM_KEY + "=sumthin", null);
        Assert.assertEquals(500, response.status);
