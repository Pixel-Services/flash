...
public class StaticFilesMemberTest {
    ...
    public void testStaticFileCssStyleCss() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/css/style.css", null);
    ...
    public void testStaticFileMjs() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/js/module.mjs", null);
    ...
    public void testStaticFilePagesIndexHtml() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/pages/index.html", null);
        Assert.assertEquals(200, response.status);
    ...
    public void testStaticFilePageHtml() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/page.html", null);
        Assert.assertEquals(200, response.status);
    ...
    public void testExternalStaticFile() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/externalFile.html", null);
        Assert.assertEquals(200, response.status);
    ...
    public void testExceptionMapping404() throws Exception {
        FlashTestUtil.UrlResponse response = testUtil.doMethod("GET", "/filethatdoesntexist.html", null);
