 ...
 */
package flash.embeddedserver.jetty;
...
import flash.embeddedserver.jetty.websocket.WebSocketServletContextHandlerFactory;
...
public class EmbeddedJettyServer implements EmbeddedServer {
    ...
    private static final int FLASH_DEFAULT_PORT = 4567;
