...
public class FlashServerHelper {
    ...
    /**
     * Statically import this for redirect utility functionality, see {@link flash.Redirect}
     */
    ...
    /**
     * Waits for the Flash server to be stopped.
    ...
    /**
     * Sets Flash to trust Forwarded, X-Forwarded-Host, X-Forwarded-Server, X-Forwarded-For, X-Forwarded-Proto, X-Proxied-Https headers
    ...
    /**
     * Sets Flash to NOT trust Forwarded, X-Forwarded-Host, X-Forwarded-Server, X-Forwarded-For, X-Forwarded-Proto, X-Proxied-Https headers
     * as defined at https://www.eclipse.org/jetty/javadoc/current/org/eclipse/jetty/server/ForwardedRequestCustomizer.html
     */
