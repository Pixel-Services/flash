...
public class MatcherFilter implements Filter {
    ...
    private flash.route.Routes routeMatcher;
     ...
     * @param externalContainer Tells the filter that Flash is run in an external web container.
     *                          If true, chain.doFilter will be invoked if request is not consumed by Flash.
     * @param hasOtherHandlers  If true, do nothing if request is not consumed by Flash in order to let others handlers process the request.
     */
    public MatcherFilter(flash.route.Routes routeMatcher,
    ...
    public void doFilter(ServletRequest servletRequest,
        ...
        try {
            ...
            if (body.notSet()) {
                LOG.info("The requested route [{}] has not been mapped in Flash for {}: [{}]",
